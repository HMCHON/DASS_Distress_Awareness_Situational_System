...
# python train.py --gpu_ids 0 --name ft_ResNet50 --train_all --batchsize 32  --data_dir '/home/lams/PycharmProjects/torchreid/Person_reID_baseline_pytorch/Market/pytorch'
