...
def parse_args_deepsort():        
    ...
    parser.add_argument("--person", action = "store", type = int, default = "1")
...
import os
os.system('/home/lams/PycharmProjects/torchreid/hm_launcher/deep_sort_hm/get_set.py /home/lams/hm/demo/test1.mp4 --display')
