    ...
    def run(self):
        ...
        while self.vdo.grab():
            ...
            if len(outputs) > 0:
                ...
                ##### capture frame #####
                dir = './reid_data_hm/' + str(idx_frame)
                os.makedirs(dir, exist_ok=True)

                id_i = 0
                for x1, y1, x2, y2 in bbox_tlwh:
                    ...
                    crop_im_name = dir +'/' + str(identities[id_i]) +'.jpg'
                    print(crop_im_name)
                    cv2.imwrite(crop_im_name, crop_im)
                    print([x1,y1,x2,y2,identities[id_i]])
                    id_i += 1
...
import os
os.system('python deepsort.py test.mp4')